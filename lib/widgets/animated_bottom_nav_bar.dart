...
/// - Floating pill-shaped container with frosted glass (BackdropFilter)
...
/// - Solid fallback when accessibility reduce-motion is enabled
        ...
        child: SafeArea(
          ...
          child: ClipRRect(
            ...
            child: BackdropFilter(
              // Glass blur — falls back to no blur if reduce-motion
              filter: reduceMotion
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  // Glass fill: translucent on dark, stronger on light
                  color: reduceMotion
                      ? (isDark
                          ? AppColors.kSurface.withValues(alpha: 0.95)
                          : Colors.white.withValues(alpha: 0.97))
                      : Colors.white.withValues(
                          alpha: isDark
                              ? GlassTokens.fillDark
                              : GlassTokens.fillLight,
                        ),
                  borderRadius: BorderRadius.circular(24),
                  border: Border.all(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        AppColors.kPrimary.withValues(alpha: isDark ? 0.2 : 0.12),
...
class _NavBarItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final activeColor = AppColors.kPrimary;
    final inactiveColor =
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            // Animated dot indicator — rose gold glow
            AnimatedContainer(
              duration: const Duration(milliseconds: 350),
              curve: Curves.easeOutCubic,
